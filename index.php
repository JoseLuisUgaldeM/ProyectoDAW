                  ...
                  <div class="modal-body">
                    <form class="row g-3">
                      <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="validationDefault10" pattern="[a-zA-Z]+" required>
                      </div>
                      <div class="col-md-12">
                        <label for="validationDefault11" class="form-label">Contraseña</label>
                        <input type="password" class="form-control" id="validationDefault11" required>
                      </div>
